...
class Wcwidth {
     ...
     * in ISO 10646.
     */
    public static wcwidth(ucs:Int) : Int {
      if (ucs == 0) return 0;
     ...
     **/
    private static inline combining : Array<Interval> = [
     ...
     **/
    private static inline ambiguous: Array<Interval> = [
    ...
    private static _bisearch(ucs:Int, table:Array<Interval>, max:Int) : Int {
        var min = 0;
        var mid : Int;
